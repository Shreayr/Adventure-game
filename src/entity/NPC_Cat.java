...
public class NPC_Cat extends Entity {
    ...
    public void setDialogue(){
        loadDialogue(
            "You step closer, carrying the gathered energy…",
            "The glow in the cat’s eyes begins to fade…",
            "Meow…",
            "(It looks at you… calmer now.)",
            "(For a moment… it seems to understand you.)"
        );
    }
